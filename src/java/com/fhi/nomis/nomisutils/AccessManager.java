...
public class AccessManager implements Serializable
{
    ...
    public List getListOfLgasAssignedToUser(User user,String stateCode)
    {
        ...
        if(user !=null)
        {
            ...
            else if(user.getUserGroupId().equalsIgnoreCase(NomisConstant.DEFAULTGRPID) || user.getUserGroupId().equalsIgnoreCase(NomisConstant.OLDDEFAULTGRPID))
            {
    ...
    public List getListOfCBOsAssignedToUser(User user,String stateCode,String lgaCode)
    {
        ...
        if(user !=null)
        {
            if(user.getUserroleId().equalsIgnoreCase(NomisConstant.SUPERUSER_ROLEID) || user.getUserGroupId().equalsIgnoreCase(NomisConstant.DEFAULTGRPID) || user.getUserGroupId().equalsIgnoreCase(NomisConstant.OLDDEFAULTGRPID))
    ...
    public List getLgaListForStartup(String stateCode,String userGroupIds)
    {
        ...
        try
        {
            ...
            if(userGroupIds.equalsIgnoreCase(NomisConstant.DEFAULTGRP) || userGroupIds.equalsIgnoreCase(NomisConstant.DEFAULTGRPID) || userGroupIds.equalsIgnoreCase(NomisConstant.OLDDEFAULTGRPID))
            {
                return lgaList;
            }
            else
    ...
    public List getStateListForStartup(User user)
    {
        ...
        try
        {
            if(user !=null)
            {
                if(user.getUserroleId() !=null && user.getUserroleId().equalsIgnoreCase(NomisConstant.SUPERUSER_ROLEID) || (user.getUserGroupId() !=null && (user.getUserGroupId().equalsIgnoreCase(NomisConstant.DEFAULTGRPID) || user.getUserGroupId().equalsIgnoreCase(NomisConstant.OLDDEFAULTGRPID))))
                {
    ...
    public List getPartnerListForReports(HttpSession session)
    {
        ...
        if(user !=null)
        {
            ...
            if(userGroupId !=null)
            {
                if(userGroupId.equalsIgnoreCase(NomisConstant.DEFAULTGRP) || userGroupId.equalsIgnoreCase(NomisConstant.DEFAULTGRPID) || userGroupId.equalsIgnoreCase(NomisConstant.OLDDEFAULTGRPID))
                 {
